...
import {BsInstagram , BsTwitter , BsPinterest , BsFacebook} from "react-icons/bs"
        ...
        >
            <div className='grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 place-items-start gap-8 text-white'>
                <div>
                    ...
                    <p className='text-sm leading-7'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident unde incidunt eveniet repellat voluptatibus temporibus delectus voluptatum? Quaerat.</p>
                </div>
                <div>
                    <div className='font-bold mb-6'>
                        Services
                ...
                <div>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <a href="" className='text-sm hover:underline'>Term & Conditions</a>
                    </div>
                </div>
                <div>
                    ...
                    <div className='text-sm'>+989356902177</div>
